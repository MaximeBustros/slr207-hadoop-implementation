		...
		try {
			...
			while (sc.hasNextLine()) {
				...
				try {
					...
					ProcessBuilder pb = new ProcessBuilder("ssh", userName + serverName, "mkdir", "-p", "/tmp/mgaby", "&&", "scp", "mgaby@tp-4b01-01:/tmp/mgaby/SLAVE.jar", userName + serverName + ":/tmp/mgaby/");
					Process p = null;
					File log = new File("/cal/homes/mgaby/Desktop/deploy.log");
					File error = new File("/cal/homes/mgaby/Desktop/deploy.err");
